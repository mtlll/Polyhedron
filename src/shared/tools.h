// I seriously felt like saying that this is a stupid fucking comment from the original code --> Sorry Eihrul. // generic useful stuff for any C++ program
#pragma once
...
#if 0
// Mike: What for?? They conflict with the std:: library as well.
...
// https://wandbox.org/permlink/8eJuKbrjem8q8srL
    #include <type_traits>
